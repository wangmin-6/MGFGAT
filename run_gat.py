...
def get():
    ...
    parser.add_argument('--batch_size', type=int, default=1)  # y
    parser.add_argument('--lr', type=float, default=0.005)  # y
    parser.add_argument('--flag', type=str, default="-source fusion")
    ...
    parser.add_argument('--weight_decay', type=float, default=0.0005)  # y
